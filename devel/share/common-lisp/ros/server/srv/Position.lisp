...
(cl:defmethod cl:initialize-instance :after ((m <Position-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name server-srv:<Position-request> is deprecated: use server-srv:Position-request instead.")))

(cl:ensure-generic-function 'X-val :lambda-list '(m))
(cl:defmethod X-val ((m <Position-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader server-srv:X-val is deprecated.  Use server-srv:X instead.")
  (X m))
...
(cl:defmethod cl:initialize-instance :after ((m <Position-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name server-srv:<Position-response> is deprecated: use server-srv:Position-response instead.")))
